...
import static com.example.weather.WeatherDesc.getWeatherDesc;
...
public class FetchData extends AsyncTask<Void, Void, Void> {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        MainActivity.data.setText(format("%s%s%s", this.weatherDescription, ", temperature is ", this.tempString));
